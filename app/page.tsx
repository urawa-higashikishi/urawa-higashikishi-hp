      ...
      <section id="map" className="py-16 bg-amber-50">
        <div className="max-w-7xl mx-auto px-0 sm:px-6 lg:px-8">
          <div className={SECTION_CARD_SM}>
            ...
            <div className="mt-6 space-y-3 text-slate-600 text-sm leading-relaxed">
              <p>
                東岸町自治会館は、JR浦和駅東口から徒歩約6分、JR南浦和駅東口から徒歩約16分の場所にあります。バスをご利用の場合は、国際興業バス「大谷場小学校」停留所が最寄りです（浦和駅からは徒歩の方が近いです）。
              </p>
              <p>
                自治会館は東通りに面し、圓蔵寺のすぐ近くに位置しています。北側には日の出通り、東〜南東方面には浦和競馬場があり、さいたま市立大谷場小学校も近接しています。
              </p>
              <p>
                東岸町は、北側・北西側で東高砂町・東仲町、東側・南東側で前地、線路を挟んで西側で岸町、南側でさいたま市南区の南本町・大谷場と隣接しています。
              </p>
            </div>
          </div>
        </div>
